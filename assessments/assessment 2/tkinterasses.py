...
def register():
    ...
    if not name_var.get() or not contact_var.get() or not email_var.get() or not gender_var.get() not in ["Male", "Female"] or not city_var.get() == "Select City" or state_var.get() == "Select State":
