...
tk.Label(form_frame, text="Name *", bg="white").grid(row=0, column=0, sticky="w", pady=2)
tk.Entry(form_frame, textvariable=name_var).grid(row=0, column=1, pady=2)


tk.Label(form_frame, text="Contact *", bg="white").grid(row=1, column=0, sticky="w", pady=2)
tk.Entry(form_frame, textvariable=contact_var).grid(row=1, column=1, pady=2)


tk.Label(form_frame, text="Email *", bg="white").grid(row=2, column=0, sticky="w", pady=2)
tk.Entry(form_frame, textvariable=email_var).grid(row=2, column=1, pady=2)


tk.Label(form_frame, text="Gender *", bg="white").grid(row=3, column=0, sticky="w", pady=2)
gender_frame = tk.Frame(form_frame, bg="white")
gender_frame.grid(row=3, column=1, pady=2)
...
tk.Label(form_frame, text="City *", bg="white").grid(row=4, column=0, sticky="w", pady=2)
ttk.Combobox(form_frame, textvariable=city_var, values=["ahemdabad", "Mumbai", "vadodara", "rajkot"]).grid(row=4, column=1, pady=2)


tk.Label(form_frame, text="State *", bg="white").grid(row=5, column=0, sticky="w", pady=2)
ttk.Combobox(form_frame, textvariable=state_var, values=["gujrat", "Delhi", "uttarakhand", "himachal"]).grid(row=5, column=1, pady=2)
